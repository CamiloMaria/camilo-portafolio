...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Backend API developed with NestJS to support all functionalities of the Plaza Lama e-commerce dashboard.",
    techStack: [
      "NestJS",
      "TypeScript",
      "Node.js",
    ...
    sourceUrl: "https://github.com/CamiloMaria/dashboard-backend",
  },
  {
    id: "3",
