...
const interests: Interest[] = [
    ...
    { name: "Deporte", icon: <Dumbbell className="w-5 h-5" />, description: "Practico regularmente running, natación y entrenamiento funcional. El deporte es mi forma de mantener equilibrio entre la mente y el cuerpo." },
    { name: "Dormir", icon: <BookOpen className="w-5 h-5" />, description: "Defensor del descanso de calidad como pilar fundamental para la productividad y creatividad. Practico técnicas de sueño consciente." },
