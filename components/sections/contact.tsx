      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div variants={itemVars} className="space-y-4">
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 flex items-center justify-center bg-[#39ff14]/20 text-[#39ff14]" aria-hidden="true">
              ...
              {/* Decorative corners */}
              <div className="absolute top-2 left-2 w-2 h-2 border-l-2 border-t-2 border-[#39ff14]" />
              <div className="absolute top-2 right-2 w-2 h-2 border-r-2 border-t-2 border-[#39ff14]" />
              <div className="absolute bottom-2 left-2 w-2 h-2 border-l-2 border-b-2 border-[#39ff14]" />
              <div className="absolute bottom-2 right-2 w-2 h-2 border-r-2 border-b-2 border-[#39ff14]" />
            </a>
